    ...
    <section>
      <div className="hero">
        ...
        <p className="hero-sub">
          Pick results. Wager points. Ride the bracket. One trophy. Who calls
          it?
        </p>
      ...
      <div className="how-grid">
        <div className="how-card">
          ...
          <p className="how-p">
            Every player is provisioned exactly 100 pts on registration. This is
            your betting stash — guard it.
          </p>
        </div>
        <div className="how-card">
          <div className="how-icon">🎯</div>
          ...
          <p className="how-p">
            Q1 Result · Q2 First Scorer · Q3 Goals O/U · Q4 Total Cards. Wager
            up to 8 pts total per match.
          </p>
        </div>
        <div className="how-card">
          <div className="how-icon">📈</div>
          ...
          <p className="how-p">
            Win doubles your wager (+100% profit). Wrong predictions forfeit the
            staked pts. Bankruptcy = read-only.
          </p>
        </div>
        <div className="how-card">
          <div className="how-icon">🏆</div>
          ...
          <p className="how-p">
            Knockout predictions earn 3× pts. Predict the winner through every
            round for compounding multipliers.
          </p>
        </div>
      </div>
    </section>
